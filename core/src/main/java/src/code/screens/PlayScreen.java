...
import src.code.b2dworldutils.WorldContactListener;
import src.code.builders.WorldBuilder;
import src.code.gamesys.GameManager;
import src.code.systems.AnimationSystem;
import src.code.systems.GhostSystem;
import src.code.systems.MovementSystem;
import src.code.systems.PillSystem;
import src.code.systems.PlayerSystem;
import src.code.systems.RenderSystem;
import src.code.systems.StateSystem;
...
public class PlayScreen implements Screen {
    ...
    public void show() {
        ...
        int highestScore = databaseManager.getHighestScore();
        if (highestScore != -1) {
    ...
    public void render(float delta) {
        ...
        Gdx.gl.glClearColor(0f, 0f, 0.11f, 1.0f);
        ...
        int finalScore = GameManager.instance.displayScore;
        ...
        if (changeScreen) {
            ...
            if (changeScreenCountDown <= 0) {
                ...
                game.setScreen(new ClosingScreen(game, finalScore));
            }
        }
    }
